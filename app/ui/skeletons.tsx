...
function CustomersMobileSkeleton() {
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4">
      ...
      <div className="border-b border-gray-100 pb-8 flex w-full items-center justify-between pt-4">
        <div className='w-1/2'>
          <div className="h-6 w-16 rounded bg-gray-100"></div>
      ...
      <div className="pt-4">
        <div className="mb-2 flex items-center">
          <div className="mr-2 h-6 w-8 rounded bg-gray-100"></div>
          <div className="h-6 w-16 rounded bg-gray-100"></div>
        </div>
      </div>      
    </div>
